        ...
        <Page>
            ...
            <form ref={formRef} className={styles.form} noValidate autoComplete="off">
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <CategoryAdder categories={modelItem.categories}
                                       updateCategories={(value) => handleChange('categories', value)}/>
                    </Grid>
                    <Grid item xs={12}>
            ...
            <ModelSaveBar isFormValid={isFormValid} modelItem={modelItem}/>
        </Page>
    );
};
